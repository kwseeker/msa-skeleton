...
public class ResponseWrapHandler implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converterType) {
        ...
        ResponseWrap responseWrapAnno = (ResponseWrap) request.getAttribute(RESPONSE_RESULT_ANNOTATION);
        return responseWrapAnno != null;
    }
    ...
    public Object beforeBodyWrite(Object body,
        ...
        return ResponseEntity.responseSuccess(body);
    }
}
