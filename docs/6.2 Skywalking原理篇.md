...
模块给 JavaAgent 带来了什么问题？

先看下处理过程：

1. 创建 JDK9ModuleExporter.EdgeClasses

    ```java
    JDK9ModuleExporter.EdgeClasses edgeClasses = new JDK9ModuleExporter.EdgeClasses();
    ```
    
    EdgeClasses 是 List<String> 容器，初始化时默认添加了下列类名，都是bytebuddy的核心类，skyworking-agent 默认将他们打包进了skyworking-agent.jar 的 org.apache.skywalking.apm.dependencies 目录下（参考 apm-agent maven-shade-plugin 配置）。
    
    ```verilog
    0 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.RuntimeType"
    1 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.This"
    2 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.AllArguments"
    3 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.AllArguments$Assignment"
    4 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.SuperCall"
    5 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.Origin"
    6 = "org.apache.skywalking.apm.dependencies.net.bytebuddy.implementation.bind.annotation.Morph"
    ```
...
JDK9ModuleExporter 有句注释 "*Since JDK 9, module concept has been introduced. By supporting that, agent core needs to open the read edge*", 大意是为了支持模块，agent core 需要开放读边界。
